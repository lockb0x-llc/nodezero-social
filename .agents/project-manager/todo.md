...
- [TODO] Q3B: Add user consent controls, selected public interests, explainable recommendations, and unified Directory/Profile/Local actions. Owner: MOBILE_APP_AGENT. Depends on Q2 and Q3A API contract. API contract is now available at `POST /v1/community-directory/refresh` and paginated `GET /v1/community-directory/index`.
