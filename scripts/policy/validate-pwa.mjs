...
const requiredChecks = [
  ...
  ['packages/mobile-app/src/wallet/recoveryBundle.ts', ['bundleVersion !== 2', 'envProfile', 'stellarNetworkPassphrase', 'decryptRecoveryPayload']],
  ['packages/mobile-app/src/wallet/recoveryBundleCrypto.ts', ['PBKDF2', 'AES-GCM', 'MIN_RECOVERY_PASSPHRASE_LENGTH']],
