...
| Consentful Pod-owner discovery and relationships | Approved architecture; implementation starting | `docs/system-description.md`, `docs/architecture.md`, `docs/adrs/consentful-discovery-communication/ADR-001-consentful-discovery-and-communication.md`, `docs/consentful-pod-owner-discovery-and-communication-plan.md` | WebID, Solid Type Indexes, Linked Data Notifications, ActivityStreams 2.0, and FOAF | Uses WebID-rooted discovery, Pod authority, inbox delivery, interoperable relationship payloads, and a compatibility social-graph projection without adopting full ActivityPub federation. | https://solidproject.org/TR/ ; https://www.w3.org/TR/ldn/ ; https://www.w3.org/TR/activitystreams-core/ ; http://xmlns.com/foaf/spec |
| Explainable derived discovery index | Planned in Milestone Q | `packages/jss-provisioner/src/communityDirectory.ts`, `packages/mobile-app/src/directory/`, `docs/consentful-pod-owner-discovery-and-communication-plan.md` | Solid public profiles and Type Index discovery; derived-index architecture informed by modern decentralized social systems | Keeps public Pod records authoritative while allowing a rebuildable search and recommendation projection with explicit consent and provenance. | https://solid.github.io/type-indexes/ ; https://atproto.com/specs/atp |
