...
|---|---|---|---|---|---|
| Solid OIDC sign-in (web) | Live on staging | `packages/mobile-app/src/contexts/SolidContext.tsx`, `packages/mobile-app/package.json` | `@inrupt/solid-client-authn-browser` | Standards-compliant Solid OIDC login/session handling in browser surfaces. | https://github.com/inrupt/solid-client-js/tree/main/packages/browser |
